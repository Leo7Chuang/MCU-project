...
## 溫濕度感測器實作
This project use DHT11 to detect temperature and humidty.
And we use webserver let the data can show via HTML.

## 溫濕度感測器
### 應用功能說明
1. Use DHT11 as sensor.
2. Use ESP32 as MCU.
...
### 系統方塊圖
![](https://github.com/Leo7Chuang/MCU-project/blob/main/images/Screenshot%202023-05-08%20at%201.17.00%20PM.png?raw=true)
...
// http://192.168.1.12/dht11?T=28&H=50 emulate data from Webclient_DHT11
...
##Project Review:
![](https://github.com/Leo7Chuang/MCU-project/blob/main/images/IMG_1489.jpeg?raw=true)
